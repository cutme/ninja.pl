(function(window, document, $, withpassion, undefined) {
	'use strict';
	
	var Form = withpassion.Form = function () { };
	...
	withpassion.Form = new Form();
	

}(window, document, jQuery, window.withpassion = window.withpassion || {}));
